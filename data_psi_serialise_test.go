...
func TestSerialisePMTDataSmallBuffer(t *testing.T) {
	...
	for name, c := range cases {
		...
		require.NoError(t, err, name)
		log.Println("TS Header: ", n)
		n, err = d.Serialise(make([]byte, 2))
		require.Error(t, err, name)
		fmt.Println(ErrNoRoomInBuffer.Error(), err.Error(), name)
		require.True(t, ErrNoRoomInBuffer.Error() == err.Error(), name)
	}
}
