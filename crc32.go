...
// table generated with following function
/*
func GenerateTables() {
	var i uint32
	fmt.Print(`var tableCRC32 = [256]uint32{`)
	for i = 0; i < 256; i++ {
		var k uint32
...
func computeCRC32old(bs []byte) uint32 {
	return updateCRC32old(crc32Polynomial, bs)
}

func updateCRC32old(crc32 uint32, bs []byte) uint32 {
	for _, b := range bs {
		for i := 0; i < 8; i++ {
